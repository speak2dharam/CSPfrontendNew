...
export declare class CKEditorComponent<TEditor extends Editor = Editor> implements AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CKEditorComponent<any>, "ckeditor", never, { "editor": "editor"; "config": "config"; "data": "data"; "tagName": "tagName"; "watchdog": "watchdog"; "editorWatchdogConfig": "editorWatchdogConfig"; "disableTwoWayDataBinding": "disableTwoWayDataBinding"; "disabled": "disabled"; }, { "ready": "ready"; "change": "change"; "blur": "blur"; "focus": "focus"; "error": "error"; }, never, never>;
}
